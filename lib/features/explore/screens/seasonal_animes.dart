...
class ExploreSeasonalAnimesScreen extends ConsumerWidget {
  const ExploreSeasonalAnimesScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) => SliverScaffold(
        title: const Text("Animes saisoniers"),
                ...
                child: Scrollbar(
                  child: OrientationBuilder(
                    builder: (context, orientation) => GridView.builder(
                      ...
                      itemCount: data.seasonalAnimes.length,
                      itemBuilder: (context, index) => AnimeTile(data.seasonalAnimes.elementAt(index)),
                    ),
                  ),
                ),
              ),
