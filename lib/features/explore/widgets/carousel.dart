...
class _CarouselViewState extends State<CarouselView> {
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsets effectivePadding = widget.padding ?? const EdgeInsets.all(4);
    ...
    final ShapeBorder effectiveShape =
        widget.shape ?? const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(28)));
