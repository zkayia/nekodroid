                ...
                AnimeCard cardBuilder(BuildContext context, element, {bool detailled=false}) {
                  ...
                  return AnimeCard(
                    image: isEpisode
                      ? GenericImage(
                        element.thumbnail,
                        // New episodes thumbnails have very strange aspect ratios
                        doNotAutoResize: true,
                      )
                      : GenericCachedImage(
                        element.thumbnail,
                        cacheHeight: detailled ? thumbWidth * 7 / 5 : null,
                        cacheWidth: detailled ? thumbWidth : null,
                      ),
                    isEpisode: isEpisode,
                    badge: isEpisode ?
                ...
                return AnimeCarousel(
                  onMoreTapped: () => Navigator.of(context).pushNamed(
                    ...
                    arguments: CarouselMoreParameters(
                      ...
                      cards: [
                        ...carousel.value.map(
                          (e) => cardBuilder(context, e, detailled: true),
                        ),
                      ],
                    ),
                  ),
